...
import LogoBillet from "../assets/LogoBillet.webp";
...
const Footer = () => {
  return (
            ...
            <div className="flex flex-col items-center justify-between  sm:flex-row py-14 px-10 gap-6 sm:gap-2">
              ...
              <div className="space-y-4 xl:col-span-1">
                ...
                <div className="flex space-x-6">
                  ...
                  <a
                    href="https://api.whatsapp.com/send?phone=34634110332"
                    target="_blank"
                  >
                    <svg
              ...
              <div className="">
                ...
                <ul className="mt-3 space-y-1">
                  <li className="text-base ">
                    Dilluns-Divendres: 10:00 - 14:00 / 16:00 - 20:30
                  </li>
    ...
    //     <img className="w-screen h-32" src={WaveBottom} alt="wave" />
    //   </div>
    //   <footer className="flex flex-col sm-flex-row items-center sm:justify-between p-10 bg-pink-600 text-white text-base">
